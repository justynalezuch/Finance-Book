...
<head>
    <meta charset="UTF-8">
    <title>Moje finanse | Strona główna</title>
...
<body class="container-fluid home">
        <div class="row h-100">
            <div class="col-md-7 order-md-2 cta">
                ...
                <h1 class="mb-4">Miejsce do zarządzania <br> Twoimi finansami!
            ...
            <div class="col-md-5 order-md-1 bg"></div>
        </div>
